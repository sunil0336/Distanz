...
<body>
    <div class="login">
        ...
        <form name="lform" action="dlogin.php" method="post">
            ...
            <div class="s-btn">
                ...
                <p>Dont't have an account?<a href="dsignup.html">Register Now</a></p>
            </div>
        </form>
    </div>
    ...
    if (isset($_POST['submit'])){
        ...
        $q = "SELECT * FROM driver WHERE username='$_POST[username]'AND password='$_POST[pwd]'";
        $r = pg_query($conn,$q);
        if (!$r) {
            echo "ERROR";
        }
